 ...
 * @author Spencer
 */
public class RandomVersus {
    
    public void RandomVsColor(int numGames)
    {
        int winner;
    ...
    public void RandomVsAggressive(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void RandomVsPassive(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void RandomVsUnit(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void RandomVsRandom(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void RandomVstestStrategy(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void RandomVsColeman(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
