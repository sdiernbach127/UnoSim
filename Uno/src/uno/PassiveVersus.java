 ...
 * @author Spencer
 */
public class PassiveVersus {
    
    public void PassiveVsColor(int numGames)
    {
        int winner;
    ...
    public void PassiveVsAggressive(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void PassiveVsPassive(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void PassiveVsUnit(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void PassiveVsRandom(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void PassiveVstestStrategy(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
    ...
    public void PassiveVsColeman(int numGames)
    {
        int winner;
        int[] players = new int[3];
        int totalTurns = 0;
